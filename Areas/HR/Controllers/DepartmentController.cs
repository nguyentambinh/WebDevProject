...
namespace QLNSVATC.Areas.HR.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Information(int page = 1)
        {
            ...
            {
                TempData["DeptError"] = "Error while loading departments.";
                ViewBag.CurrentPage = 1;
                ViewBag.TotalPages = 1;
                ViewBag.TotalDepartments = 0;
                ViewBag.EmployeeCountByDept = new Dictionary<string, int>();
                ViewBag.HeadNameByDept = new Dictionary<string, string>();
                ViewBag.AreaNameByDept = new Dictionary<string, string>();
                ViewBag.AreaList = new List<DTTHEOKV>();
                return View(new List<PHONGBAN>());
            }
        }
        ...
        public ActionResult Details(string id)
        {
            ...
            {
                TempData["DeptError"] = "Error while loading department details.";
                return RedirectToAction("Information");
            }
        }
        ...
        public JsonResult AddEmployee(string mapb, string manv)
        {
            ...
            {
                return Json(new { success = false, message = "System error while adding employee to department." });
            }
        }
        ...
        public JsonResult RemoveEmployee(string mapb, string manv)
        {
            ...
            {
                return Json(new { success = false, message = "System error while removing employee from department." });
            }
        }
        ...
        public JsonResult PromoteToHead(string mapb, string manv)
        {
            ...
            {
                return Json(new { success = false, message = "System error while promoting employee to Head of Department." });
            }
        }
        ...
        public JsonResult CreateInline(string tenpb, string diadiemCode)
        {
            ...
            {
                return Json(new { success = false, message = "System error while creating department." });
            }
        }
        ...
        public JsonResult UpdateInfo(string mapb, string tenpb, string diadiemCode)
        {
            ...
            {
                return Json(new { success = false, message = "System error while updating department information." });
            }
        }
