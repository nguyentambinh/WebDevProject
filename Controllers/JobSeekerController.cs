...
>>>>>>> Stashed changes
        ...
        private static string SlugCandidateName(string name)
        {
            name = RemoveDiacritics(name ?? string.Empty).Trim().Replace(" ", string.Empty);
...
>>>>>>> Stashed changes
        ...
        {
            string timeFull = dt.ToString("yyyyMMddHHmmss");
            string safeType = RemoveDiacritics(typeCode ?? "File")
                .Trim()
                .Replace(" ", string.Empty);
            return $"{timeFull}_{safeType}{ext}";
        }
            ...
            HttpPostedFileBase fileKhac)
        {
            ...
            try
            {
                ...
                else if (model.TENUNGVIEN.Length > 100)
                {
                ...
                else if (model.EMAIL.Length > 150 ||
                ...
                else if (!IsValid(fileThongTin.FileName, new[] { ".pdf", ".doc", ".docx", ".jpg", ".jpeg", ".png" }))
                {
                ...
                else if (!IsValid(fileBangCap.FileName, new[] { ".pdf", ".jpg", ".jpeg", ".png" }))
                {
...
>>>>>>> Stashed changes
                ...
                string folderName = BuildCandidateFolderName(model.TENUNGVIEN, now);
                ...
                if (fileThongTin != null && fileThongTin.ContentLength > 0)
                {
                    ...
                    string newFileName = BuildNormalizedFileName("ThongTin", now, ext);
                ...
                if (fileBangCap != null && fileBangCap.ContentLength > 0)
                {
                    ...
                    string newFileName = BuildNormalizedFileName("BangCap", now, ext);
                ...
                if (fileKhac != null && fileKhac.ContentLength > 0)
                {
                    ...
                    string newFileName = BuildNormalizedFileName("Khac", now, ext);
